...
<?php
$id_tienich = array('591','592','638','759');
            ...
            <section class='innerContent'>
                <article class='post-heading hentry'>
                    <div class="form-group post_content entry-content">
                        ...
                        <?php
                        foreach ($id_tienich as $numbergoi => $post) {
                        ...
                        <div id="<?php echo $idnhom; ?>" class="nhom-goi" style="margin-top: 40px;">
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    ?>
                                    <div class="col-md-6x col-sm-6 category-list"   style="margin-left: 15px;margin-right: 0px;margin-bottom:1%">
                                        <h3 align="center"
