...
<?php get_header(); ?>
    <div class="container">
                ...
                <div>
                    <ol class="breadcrumb">
                        <li itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a
                                    href="<?php echo get_home_url() ?>" itemprop="url"><i
                                        class="glyphicon glyphicon-home"></i> <span itemprop="title">Home</span></a>
                        </li>
                        <li itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a
                                    href="<?php echo get_home_url() ?>/<?php echo get_the_category(get_the_ID())[0]->slug; ?>"
                                    itemprop="url"><span
                                        itemprop="title"><?php echo get_the_category(get_the_ID())[0]->name; ?></span></a>
                        </li>
                        <li class="hidden-xs" itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><span
                                    itemprop="title"><a itemprop='url'><?php echo get_the_title() ?></a></span>
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-8">
                <h1 class="post_title single-title entry-title"><?php echo get_the_title() ?></h1>
            </div>
        </div>
                    ...
                    <section class='innerContent'>
                        <article class='post-heading hentry'>
                            <div class="form-group post_content entry-content">
                                ...
                                $datas = get_field('goi_cuoc', $post);
                                ?>
                                <div id="<?php echo $idnhom; ?>" class="row nhom-goi"
                                     style="margin-top: 40px;border: 2px solid #00a1e4;">
                                    <div style="background: <?php echo $bangmau[$numbergoi % 2]; ?>;height: 50px">
                                        <h3 align="center"
                                            ...
                                            class="nhom-goi-tite" title="<?php echo $idnhom ?>">
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <p style="margin-left: 15px;"><b>Ghi chú
